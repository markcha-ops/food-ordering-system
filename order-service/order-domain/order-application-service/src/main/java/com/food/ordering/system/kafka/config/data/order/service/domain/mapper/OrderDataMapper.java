package com.food.ordering.system.kafka.config.data.order.service.domain.mapper;
...
public class OrderDataMapper {
    ...
    private List<com.food.ordering.system.kafka.config.data.order.service.domain.enriry.OrderItem> orderItemsToOrderItemEntities(
            List<OrderItem> items) {
        return items.stream()
                .map(orderItem -> com.food.ordering.system.kafka.config.data.order.service.domain.enriry.OrderItem.builder()
