...
import com.food.ordering.system.kafka.config.data.order.service.domain.exception.OrderNotFountException;
...
public class OrderGlobalExceptionHandler extends GlobalExceptionHandler {
    ...
    public ErrorDTO handleException(OrderNotFountException orderDomainException) {
        log.error(orderDomainException.getMessage(), orderDomainException);
        return ErrorDTO.builder()
